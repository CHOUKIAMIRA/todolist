...
function TaskCompleted({ visible, setVisible }) {
  ...
  return (
    <div>
      ...
      <section>
        ...
        <main><Completed tasks={tasks} /></main>
        <nav style={{ marginLeft: "90px", marginTop: "0" }}>
          <Link to="/"><button>Add Task</button></Link>
          <br /><br /><br />
          <Link to="/taskcompleted"><button style={{ backgroundColor: "orange" }}>Task Completed</button></Link>
          <br /><br /><br />
